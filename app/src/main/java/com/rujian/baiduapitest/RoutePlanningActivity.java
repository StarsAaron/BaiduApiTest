...
public class RoutePlanningActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        biking_btn = (Button) findViewById(R.id.biking_btn);
        ...
        String[] transitItems = getResources().getStringArray(R.array.transit_spinner);
        ArrayAdapter<String> transitAdapter = new ArrayAdapter<>(this, android.R.layout.simple_spinner_item, transitItems);
    ...
    OnGetRoutePlanResultListener routePlanResultListener = new OnGetRoutePlanResultListener() {
        ...
        public void onGetWalkingRouteResult(WalkingRouteResult walkingRouteResult) {
            ...
            if (walkingRouteResult.error == SearchResult.ERRORNO.NO_ERROR) {
                ...
                Toast.makeText(RoutePlanningActivity.this, "共查询出" + totalLine + "条符合条件的线路", Toast.LENGTH_SHORT).show();
                if (totalLine > 1) {
        ...
        public void onGetTransitRouteResult(TransitRouteResult transitRouteResult) {
            ...
            if (transitRouteResult.error == SearchResult.ERRORNO.NO_ERROR) {
                ...
                Toast.makeText(RoutePlanningActivity.this, "该路线打车总路程"
                        + transitRouteResult.getTaxiInfo().getDistance(), Toast.LENGTH_SHORT).show();
            }
        }
        ...
        public void onGetDrivingRouteResult(DrivingRouteResult drivingRouteResult) {
            ...
            if (drivingRouteResult.error == SearchResult.ERRORNO.NO_ERROR) {
                ...
                // 通过getTaxiInfo()可以得到很多关于打车的信息
                Toast.makeText(
                        RoutePlanningActivity.this, "该路线打车总路程" + drivingRouteResult.getRouteLines().get(drivintResultIndex).getDistance(), Toast.LENGTH_SHORT).show();
            }
        }
        ...
        public void onGetBikingRouteResult(BikingRouteResult bikingRouteResult) {
            ...
            if (bikingRouteResult.error == SearchResult.ERRORNO.NO_ERROR) {
                BikingRouteOverlay bikingRouteOverlay = new BikingRouteOverlay(bdMap);
                bikingRouteOverlay.setData(bikingRouteResult.getRouteLines().get(drivintResultIndex));
                bdMap.setOnMarkerClickListener(bikingRouteOverlay);
                bikingRouteOverlay.addToMap();
                bikingRouteOverlay.zoomToSpan();
                totalLine = bikingRouteResult.getRouteLines().size();
                Toast.makeText(RoutePlanningActivity.this, "共查询出" + totalLine + "条符合条件的线路", Toast.LENGTH_SHORT).show();
                if (totalLine > 1) {
                    nextLineBtn.setEnabled(true);
                }
                // 通过getTaxiInfo()可以得到很多关于打车的信息
                Toast.makeText(RoutePlanningActivity.this, "该路线总路程"
                        + bikingRouteResult.getRouteLines().get(drivintResultIndex).getDistance(), Toast.LENGTH_SHORT).show();
            }
        }
    };
     ...
     * 骑行路线查询
     */
    private void bikingSearch() {
        BikingRoutePlanOption bikingRoutePlanOption = new BikingRoutePlanOption();
        bikingRoutePlanOption.from(PlanNode.withCityNameAndPlaceName("北京", startPlace));
        bikingRoutePlanOption.to(PlanNode.withCityNameAndPlaceName("北京", endPlace));
