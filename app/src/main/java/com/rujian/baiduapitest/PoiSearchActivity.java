	...
	OnGetPoiSearchResultListener poiSearchListener = new OnGetPoiSearchResultListener() {
		...
		public void onGetPoiResult(PoiResult poiResult) {
			...
			if (poiResult.error == SearchResult.ERRORNO.NO_ERROR) {// 检索结果正常返回
				...
				Toast.makeText( PoiSearchActivity.this, "总共查到" + poiResult.getTotalPoiNum() + "个兴趣点, 分为"
	...
	OnGetShareUrlResultListener shareUrlResultListener = new OnGetShareUrlResultListener() {
		...
		public void onGetPoiDetailShareUrlResult(ShareUrlResult arg0) {
			if (arg0.error != SearchResult.ERRORNO.NO_ERROR) {
				...
				Toast.makeText(PoiSearchActivity.this, "poi详情分享url：" + arg0.getUrl(),
		...
		public void onGetLocationShareUrlResult(ShareUrlResult arg0) {
			if (arg0.error != SearchResult.ERRORNO.NO_ERROR) {
				...
				Toast.makeText(PoiSearchActivity.this,  "请求位置信息分享url：" + arg0.getUrl(),
						Toast.LENGTH_LONG).show();
			}
		}
		...
		public void onGetRouteShareUrlResult(ShareUrlResult shareUrlResult) {
			if (shareUrlResult.error != SearchResult.ERRORNO.NO_ERROR) {
				...
				Toast.makeText(PoiSearchActivity.this,  "请求路线位置信息分享url：" + shareUrlResult.getUrl(),
						Toast.LENGTH_LONG).show();
			}
		}
	};
	...
	class MyPoiOverlay extends PoiOverlay {
		...
		public boolean onPoiClick(int arg0) {
			...
			shareUrlSearch.requestLocationShareUrl(new LocationShareURLOption()
					.location(poiInfo.location).name("共享点名称").snippet("点我吧"));
